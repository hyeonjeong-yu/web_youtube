...
const Video = props => {
    ...
    useEffect(() => {
        fetch(
            `https://youtube.googleapis.com/youtube/v3/videos?part=snippet,statistics&id=${videoID}&type=video&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`,
        )
    ...
    return (
        <Main title='유튜브 비디오 영상' description='유튜브 비디오 영상을 볼 수 있는 페이지입니다.'>
